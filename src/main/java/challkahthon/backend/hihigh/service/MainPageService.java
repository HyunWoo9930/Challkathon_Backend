...
public class MainPageService {
    ...
    public MainPageResponseDto getPersonalizedMainPageNews(String username) {
        ...
        try {
            ...
            List<CareerNews> personalizedNews = careerNewsRepository.findPersonalizedNews(user, PageRequest.of(0, 50));

            Map<String, List<CareerNewsDto>> newsByKeyword = classifyNewsByUserKeywords(personalizedNews, userInputKeywords);
